...
public class Player : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider hitCollider)
    {
        ...
        if (hitCollider.tag == "Blue Diamond")
        {
            //GameObject.FindGameObjectsWithTag("Blue Diamond").
            objective = GameObject.Find("gem");
            objective.GetComponent<Renderer>().enabled = false;
            objective = objective.transform.GetChild(0).gameObject;
